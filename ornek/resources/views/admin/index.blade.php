...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{asset('assets_dash')}}/images/favicon.ico">



    <!-- App css -->
    <link href="{{asset('assets_dash')}}/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('assets_dash')}}/css/icons.min.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('assets_dash')}}/css/app.min.css" rel="stylesheet" type="text/css" />
        ...
        <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">
            ...
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                ...
                <li class="dropdown">
                    <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#" role="button"
                       aria-haspopup="false" aria-expanded="false" data-bs-offset="0,19">
                        <img src="{{asset('assets_dash')}}/images/flags/us_flag.jpg" alt="" class="thumb-sm rounded-circle">
                    </a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#"><img src="{{asset('assets_dash')}}/images/flags/us_flag.jpg" alt="" height="15" class="me-2">English</a>
                        <a class="dropdown-item" href="#"><img src="{{asset('assets_dash')}}/images/flags/spain_flag.jpg" alt="" height="15" class="me-2">Spanish</a>
                        <a class="dropdown-item" href="#"><img src="{{asset('assets_dash')}}/images/flags/germany_flag.jpg" alt="" height="15" class="me-2">German</a>
                        <a class="dropdown-item" href="#"><img src="{{asset('assets_dash')}}/images/flags/french_flag.jpg" alt="" height="15" class="me-2">French</a>
                    </div>
                ...
                <li class="dropdown topbar-item">
                    <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#" role="button"
                       aria-haspopup="false" aria-expanded="false" data-bs-offset="0,19">
                        <img src="{{asset('assets_dash')}}/images/users/avatar-1.jpg" alt="" class="thumb-md rounded-circle">
                    </a>
...
<div class="startbar d-print-none">
    ...
    <div class="brand">
        <a href="index.html" class="logo">
                <span>
                    <img src="{{asset('assets_dash')}}/images/logo-sm.png" alt="logo-small" class="logo-sm">
                </span>
            <span class="">
                    <img src="{{asset('assets_dash')}}/images/logo-light.png" alt="logo-large" class="logo-lg logo-light">
                    <img src="{{asset('assets_dash')}}/images/logo-dark.png" alt="logo-large" class="logo-lg logo-dark">
                </span>
        </a>
    </div>
    <!--end brand-->
            ...
            <div class="d-flex align-items-start flex-column w-100">
                ...
                <div class="update-msg text-center">
                    <div class="d-flex justify-content-center align-items-center thumb-lg update-icon-box  rounded-circle mx-auto">
                        ...
                        <img src="{{asset('assets_dash')}}/images/extra/gold.png" alt="" class="" height="45">
                    </div>
                            ...
                            <div class="card  bg-welcome-img overflow-hidden">
                                <div class="card-body">
                                    <div class="">
                                        ...
                                        <img src="{{asset('assets_dash')}}/images/extra/fund.png" alt="" class=" mb-n4 float-end" height="107">
                                    </div>
                                </div><!--end card-body-->
                            </div><!--end card-->
                        </div><!--end col-->
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <form class="">
                                                <select id="dynamic-select" name="example-select" data-placeholder="Select an option" data-dynamic-select>
                                                    <option value="1" data-img="{{asset('assets_dash')}}/images/logos/m-card.png">xx25</option>
                                                    <option value="2" data-img="{{asset('assets_dash')}}/images/logos/ame-bank.png">xx56</option>
                                                </select>
                                            </form>
                                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class=" text-center mx-auto">
                                <img src="{{asset('assets_dash')}}/images/extra/rabit.png" alt="" class="d-inline-block" height="105">
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr class="">
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/flags/us_flag.jpg" class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                                    ...
                                    <tr class="">
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/flags/spain_flag.jpg" class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                                    ...
                                    <tr class="">
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/flags/french_flag.jpg" class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                                    ...
                                    <tr class="">
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/flags/germany_flag.jpg" class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                                    ...
                                    <tr class="">
                                        <td class="px-0 pb-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/flags/baha_flag.jpg" class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/logos/lang-logo/chatgpt.png" height="40" class="me-3 align-self-center rounded" alt="...">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/logos/lang-logo/gitlab.png" height="40" class="me-3 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/logos/lang-logo/nextjs.png" height="40" class="me-3 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/logos/lang-logo/vue.png" height="40" class="me-3 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate">
                                                    <h6 class="m-0">Vue</h6>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/logos/lang-logo/symfony.png" height="40" class="me-3 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate">
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr class="">
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/users/avatar-1.jpg" height="36" class="me-2 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate">
                                    ...
                                    <tr class="">
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/users/avatar-2.jpg" height="36" class="me-2 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate">
                                    ...
                                    <tr class="">
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/users/avatar-3.jpg" height="36" class="me-2 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate">
                                    ...
                                    <tr class="">
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/users/avatar-4.jpg" height="36" class="me-2 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate">
                                    ...
                                    <tr>
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/users/avatar-5.jpg" height="36" class="me-2 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate">
                                    ...
                                    <tr class="">
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets_dash')}}/images/users/avatar-9.jpg" height="36" class="me-2 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate">
                                                    <h6 class="m-0 text-truncate">Steven Sharp </h6>
                                                    <a href="#" class="font-12 text-muted text-decoration-underline">#4521</a>
                                                </div><!--end media body-->
...
<script src="{{asset('assets_dash')}}/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="{{asset('assets_dash')}}/libs/simplebar/simplebar.min.js"></script>

<script src="{{asset('assets_dash')}}/libs/apexcharts/apexcharts.min.js"></script>
<script src="https://apexcharts.com/samples/assets/stock-prices.js"></script>
<script src="{{asset('assets_dash')}}/js/pages/index.init.js"></script>
<script src="{{asset('assets_dash')}}/js/DynamicSelect.js"></script>
